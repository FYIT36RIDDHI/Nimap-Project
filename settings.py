...
SECRET_KEY = "django-insecure-*lynzr$*)zimlsw4$2##gl&h=#vq8n^i*b17@qhq-b79iikc^x"
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # Example: 15 minutes for access tokens
    ...
    'BLACKLIST_AFTER_ROTATION': True,  # Optional: Blacklist previous refresh tokens
}
